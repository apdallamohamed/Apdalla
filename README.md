...
<body>
  ...
  <header>
    <img class="avatar" src="https://avatars.githubusercontent.com/u/your-avatar-id" alt="Apdalla Mohamed" />
    <h1>👋 Hi, I'm Apdalla Mohamed</h1>
    <p>Full Stack Developer | AI Engineer | Cybersecurity Expert</p>
  </header>

  <section>
    <h2>🎓 Career Timeline</h2>
    <ul class="timeline">
      <li><strong>2025:</strong> Full Stack & AI Developer at Vibe Coding</li>
      <li><strong>2024:</strong> BSc in Cybersecurity – Hodmas University College</li>
      <li><strong>2023:</strong> BSc in Computer Science – Jamhuriya University of Science & Technology</li>
    </ul>
  </section>
  ...
  <section>
    ...
    <iframe src="https://visitor-badge.laobi.icu/badge?page_id=apdallamohamed.apdallamohamed"></iframe>
  </section>
